<?php
	...
	if (isset($_POST['full_name']) && isset($_POST['phone_num']) && isset($_POST['email_addr']) && isset($_POST['msg'])) 
	{
		...
		$mail->isSMTP();
		$mail->Host="mail.dakshsoftwaresolution.com";
		$mail->Port=587;
		$mail->SMTPSecure="tls";
		$mail->SMTPAuth=true;
		$mail->Username="info@dakshsoftwaresolution.com";
		$mail->Password="Seawood42@11feb";
		$mail->SetFrom("info@dakshsoftwaresolution.com");
		$mail->addAddress("info@dakshsoftwaresolution.com");
